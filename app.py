...
@app.route('/')
def home():
    return "I'am DG GAMING File Host"
...
# --- Configuration ---
TOKEN = '7497555469:AAFHk4sJM5OrdKL7UbUHON3AK62yHVJC7A8' # Replace with your actual token
OWNER_ID = 7768630615 # Replace with your Owner ID
ADMIN_ID = 7704845965 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@teamsXdark' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/LEADER_ABHAY_FREE_API' # Replace with your update channel link
